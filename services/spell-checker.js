...
const sySpell = require("node-symspell");
const natural = require("natural");

/**  
  Fix any mispelled word or typos word.
*/
async function spellChecker(wordBounds) {
  ...
  const symSpell = new sySpell(maxEditDistance, prefixLength)
  await symSpell.loadDictionary("./resources/data/id.txt", 0, 1)

  const results = symSpell.lookupCompound(wordsCombine, maxEditDistance)
